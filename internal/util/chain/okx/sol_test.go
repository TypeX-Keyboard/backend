...
func Test_NewAddess(t *testing.T) {
	...
	address, err := solana.NewAddress(hex.EncodeToString(pk.Bytes()))
	require.NoError(t, err)
	require.True(t, solana.ValidateAddress(address))
	g.Dump(pk.String())
	g.Dump(address)
}
...
func Test_TransferTransaction(t *testing.T) {
	...
	rawTransaction := solana.NewRawTransaction(hash, from)
...
func Test_UnMarshall(t *testing.T) {
	...
	tx, _ := solana.DecodeAndSign(rawTx, signers, hash, true)
	expected := ""
	require.Equal(t, expected, tx)
}
...
func Test_UnMarshall2(t *testing.T) {
	...
	tx, err := solana.DecodeAndMultiSign(unsignedTx, hex.EncodeToString(fromPrivate.Bytes()), hash, true)
	require.NoError(t, err)
	expected := ""
	require.Equal(t, expected, tx)
}
...
func Test_TransferTransaction1(t *testing.T) {
	...
	tx, _ := solana.SignedTx(hash, from, to, nonceAddress, 10000, sign)
